...
from utils.vector_utils import flatten_optimizer_state, reconstruct_optimizer_state
...
def test_flatten_optimizer_state(optimizer_setup):
    ...
    flat_tensor, tensor_shapes, state_dict = flatten_optimizer_state(optimizer)
